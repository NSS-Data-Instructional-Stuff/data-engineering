...
The base URL is `https://developyr-api.azurewebsites.net/api`
...
### Part 2
Next, set up Postman for authentication. Create a Collection. Navigate to the collection that you just created and choose the authorization tab. Set **Auth Type** as **Bearer Token**, then paste the token that you received above in for token. 
...
Copy and paste the JSON that you recieved in the response and save it to a file called `response.json`. 
